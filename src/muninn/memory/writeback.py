...
def write_candidates(
    ...
    for candidate in candidates:
        ...
        if candidate.kind == "fact":
            ...
            db.execute_one(
                conn,
                "INSERT INTO episodes (id, entity_id, summary, start_ts, end_ts, confidence, provenance_json, created_at) VALUES (?,?,?,?,?,?,?,?)",
            ...
            db.execute_one(
                conn,
                "INSERT INTO preferences (id, entity_id, key, value, confidence, decay_ts, provenance_json, created_at) VALUES (?,?,?,?,?,?,?,?)",
