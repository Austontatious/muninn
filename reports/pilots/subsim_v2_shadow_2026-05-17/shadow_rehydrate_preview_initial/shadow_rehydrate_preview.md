...
- `8d0704f3-2903-44df-937c-c80902b20f64` SubSim x ReadyPlayer1 campaign ledger checkpoint updated through Campaign 003
  - stage: `primary_retrieval` kind: `decision` updated: `2026-05-07 16:01:24` score=`83.980211`
...
- `f94af521-4f75-4f42-b9d6-8a10b66d4a0d` SubSim Campaign 004A preserved gameplay while ReadyPlayer1 improved fire-control policy
  - stage: `primary_retrieval` kind: `interface` updated: `2026-05-07 16:18:10` score=`75.131649`
...
- `b97c8e3f-2a41-4031-946f-2f57b87f2bc2` SubSim x ReadyPlayer1 preflight documented and Campaign 001 selected
  - stage: `primary_retrieval` kind: `decision` updated: `2026-05-07 14:39:41` score=`75.114139`
...
- `2fbc9cf8-118c-4a0d-84bc-a5ee90716adb` SubSim fire_control observation contract v1
  - stage: `recent_in_scope_supplement` kind: `interface` updated: `2026-05-07 17:05:15`
...
- `66312a31-2eca-4931-8f28-ae75a2dc7411` Campaign 004A leaves SubSim fire-control physics unchanged
  - stage: `recent_in_scope_supplement` kind: `interface` updated: `2026-05-07 16:43:30`
...
- `4d5faed6-e51e-4bc1-8ca1-8ebedcbc18d9` Hydrophone fixtures feed ReadyPlayer1 acoustic clutter scoring
  - stage: `recent_in_scope_supplement` kind: `interface` updated: `2026-05-07 16:33:57`
...
- `5e260af6-8b17-427f-832d-028fae69d295` Hydrophone fixed eval and acoustic fixtures
  - stage: `recent_in_scope_supplement` kind: `interface` updated: `2026-05-07 16:14:11`
...
- `a4659ce9-bcf2-4615-9c37-4c09601943ab` Hydrophone corpus expansion v2
  - stage: `recent_in_scope_supplement` kind: `interface` updated: `2026-05-07 15:59:36`
...
- `fb91d94b-b9e2-4bd8-a970-ff315747cd2d` SubSim sonar tracks expose explicit lifecycle state
  - stage: `recent_in_scope_supplement` kind: `interface` updated: `2026-05-07 15:34:51`
...
- `1fff427d-0f12-44cd-a002-56f1516745fb` Bounded hydrophone pipeline
  - stage: `recent_in_scope_supplement` kind: `interface` updated: `2026-05-07 15:34:42`
  - summary: SubSim now has a bounded hydrophone corpus pipeline under data/hydrophone and scripts/hydrophone.
  - body excerpt: The slice supports dry-run dataset manifests, small real-sample fetch/copy, normalization to 16 kHz mono WAV, baseline feature extraction, stable source-path grouped RandomForest reporting, and synthetic wave generation with explicit synthetic-not-real-submarine disclaimers.
...
- `12583c95-c343-4350-bae7-0b882ed70d96` Campaign 001 sonar clutter readability producer behavior
  - stage: `recent_in_scope_supplement` kind: `decision` updated: `2026-05-07 15:11:24`
...
- `14d4b7a7-b338-4ede-bdad-36278a07392e` Godot mobile controls now include explicit Ping and gameplay-effective Fire
  - stage: `recent_in_scope_supplement` kind: `decision` updated: `2026-04-24 02:45:57`
...
- Evidence refs available on preview cards: 45
- Evidence refs included in report: 45
- Retrieval mode: `hybrid`
