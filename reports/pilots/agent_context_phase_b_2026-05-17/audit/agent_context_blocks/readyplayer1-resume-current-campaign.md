...
source_v2_db: /mnt/data/Muninn/reports/pilots/readyplayer1_v2_shadow_2026-05-17/readyplayer1_shadow_v2.db
...
- [2656c35f-79af-403d-9128-e98fc72663d6] Campaign 003 promoted for SubSim clutter binding
  ...
  explanation: path=recent_in_scope_shadow_supplement sources=['scope_key', 'status', 'updated_at'] tokens=[]
- [4be809aa-731f-420c-8dc1-99cb5813c0ea] Campaign 002A promoted for SubSim sonar lifecycle diagnostics
  kind: decision status: active stage: recent_in_scope_supplement
  score: None rank: None
  summary: Campaign 002A added explicit sonar contact lifecycle states and lifecycle-aware ReadyPlayer1 diagnostics. The belief_baseline suite stayed at 7 pass / 0 fail with golden regression pass, while clutter_false_positive removed binding_ambiguity_abandonment and preserved clutter_binding_error.
  body: Durable outcome: SubSim sonar tracks now expose lifecycle states, ReadyPlayer1 normalizes them as contact_lifecycle_state, and metrics separate active ambiguity from terminal rejected/lost contacts. Key clutter_false_positive movement: sonar_binding_ambiguity_abandonment_rate 1.0 -> 0.0, action_thrash 4 -> 4, false_positive_rate held at 0.2857142857142857.
  evidence: /mnt/data/ReadyPlayer1/reports/campaign_002a_comparison.json; /mnt/data/ReadyPlayer1/reports/campaign_002a_after.md; /mnt/data/ReadyPlayer1/reports/campaign_002a_promotion_decision.md
  explanation: path=recent_in_scope_shadow_supplement sources=['scope_key', 'status', 'updated_at'] tokens=[]
- [f5021943-807e-4015-a4d6-a24e1f8b8db4] Campaign 001 promoted on belief_baseline clutter evidence
  kind: decision status: active stage: recent_in_scope_supplement
  score: None rank: None
  summary: ReadyPlayer1 Campaign 001 after evaluation promoted the sonar clutter readability patch using the belief_baseline lane, not a learned/shadow lane.
  body: Final after suite reports/campaign_001_after_runs/20260507T150834Z-subsim_suite-3e1734 passed all 7 scenario expectations and golden regression. clutter_false_positive false-positive rate improved from 0.5 to 0.2857142857142857; overconfident weak-contact rate improved from 1.0 to 0.0. Scenario expectation stayed unchanged at max 0.35; the suite golden threshold was tightened to enforce that bound. Reports written: campaign_001_after.md, campaign_001_comparison.json, campaign_001_promotion_decision.md.
  evidence: /mnt/data/ReadyPlayer1/reports/campaign_001_comparison.json; /mnt/data/ReadyPlayer1/reports/campaign_001_after.md; /mnt/data/ReadyPlayer1/reports/campaign_001_promotion_decision.md
  explanation: path=recent_in_scope_shadow_supplement sources=['scope_key', 'status', 'updated_at'] tokens=[]
- [fb80c2a4-3025-4a64-bd60-3cbf7484b2d2] SubSim ReadyPlayer1 evaluation contract v1 documented
  ...
  explanation: path=recent_in_scope_shadow_supplement sources=['scope_key', 'status', 'updated_at'] tokens=[]
- [c7a9d5cf-187b-4d6d-9637-f6d191b512f3] Qwen3.6-27B isolated vLLM trial on V100 (sm_70) parses but fails to reach API-ready state
  kind: runbook status: active stage: recent_in_scope_supplement
  score: None rank: None
  summary: Isolated container trials for /mnt/data/models/Qwen/qwen36-27b-test using vLLM 0.19.1 + Transformers 5.5.4 passed offline parse/import checks but failed to expose a usable OpenAI API on port 8018. Model weights loaded on GPUs 0/1 in FP16, but engine initialization stalled with repeated shared-memory broadcast waits and Volta capability warnings.
  body: Baseline was captured and restored, including rollback to live Lexi on :8008. Two bounded GPU boot attempts were run (standard and language-model-only/disable-custom-all-reduce). Both attempts preserved served model name Lexi and loaded checkpoints, but /v1/models on :8018 returned empty replies throughout. Logs repeatedly showed FA2 capability warnings for compute capability >=8 and SymmMem communicator unsupported on cc 7.0. Recommendation: treat current prebuilt vLLM path as not production-viable on V100 for Qwen3.6; next step is a source-built sm_70 constrained backend experiment or alt...
  evidence: /mnt/data/model_swap_eval/qwen36_27b_isolated_trial/compatibility_requirements.md; /mnt/data/model_swap_eval/qwen36_27b_isolated_trial/post_restore_smoke_chat_success.json; /mnt/data/model_swap_eval/qwen36_27b_isolated_trial/failure_classification.md; /mnt/data/model_swap_eval/qwen36_27b_isolated_trial/trial_report.txt
  explanation: path=recent_in_scope_shadow_supplement sources=['scope_key', 'status', 'updated_at'] tokens=[]
...
- [001a6c4f-e107-4927-bef1-1179e008a94f] card=4be809aa-731f-420c-8dc1-99cb5813c0ea type=file ref=/mnt/data/ReadyPlayer1/reports/campaign_002a_comparison.json
- [0e848eaa-7663-42f3-9f43-b94ee4e6b919] card=4be809aa-731f-420c-8dc1-99cb5813c0ea type=file ref=/mnt/data/ReadyPlayer1/reports/campaign_002a_after.md
- [cb4bfca4-9f40-4ce1-ade7-2096ca796a09] card=4be809aa-731f-420c-8dc1-99cb5813c0ea type=file ref=/mnt/data/ReadyPlayer1/reports/campaign_002a_promotion_decision.md
...
- [211904ac-37be-47d8-aa34-25bc7204623f] card=c7a9d5cf-187b-4d6d-9637-f6d191b512f3 type=file ref=/mnt/data/model_swap_eval/qwen36_27b_isolated_trial/compatibility_requirements.md
- [295fe6ea-22f7-4cff-8e5b-93f272a21c48] card=c7a9d5cf-187b-4d6d-9637-f6d191b512f3 type=file ref=/mnt/data/model_swap_eval/qwen36_27b_isolated_trial/post_restore_smoke_chat_success.json
- [4c7f729c-e78c-4367-a95f-562389d744e2] card=c7a9d5cf-187b-4d6d-9637-f6d191b512f3 type=file ref=/mnt/data/model_swap_eval/qwen36_27b_isolated_trial/failure_classification.md
- [7480d84b-d53c-44f8-954e-92f9a08cd0da] card=c7a9d5cf-187b-4d6d-9637-f6d191b512f3 type=file ref=/mnt/data/model_swap_eval/qwen36_27b_isolated_trial/trial_report.txt
...
- [0b178e05-aa7d-4ef8-99c7-67ac62eaf8ef] card=f5021943-807e-4015-a4d6-a24e1f8b8db4 type=file ref=/mnt/data/ReadyPlayer1/reports/campaign_001_comparison.json
- [937e7475-2643-4390-99a6-aa9c3b17a034] card=f5021943-807e-4015-a4d6-a24e1f8b8db4 type=file ref=/mnt/data/ReadyPlayer1/reports/campaign_001_after.md
- [9ae69092-4cc2-454f-b69b-e925e26a59bf] card=f5021943-807e-4015-a4d6-a24e1f8b8db4 type=file ref=/mnt/data/ReadyPlayer1/reports/campaign_001_promotion_decision.md
