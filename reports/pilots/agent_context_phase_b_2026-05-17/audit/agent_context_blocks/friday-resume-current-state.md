...
source_v2_db: /mnt/data/Muninn/reports/pilots/friday_v2_shadow_2026-05-17/friday_shadow_v2.db
...
- [849362c5-ed42-43a2-9084-897ecf2c7de1] Friday root now has explicit Mimir repo-cognition entrypoints separated from runtime memory
  ...
  explanation: path=recent_in_scope_shadow_supplement sources=['scope_key', 'status', 'updated_at'] tokens=[]
- [da270af3-a737-4ad5-a652-92751cb57de2] Hard-gate trial for routing_001 traceback guard set to manual_review
  kind: decision status: active stage: recent_in_scope_supplement
  score: None rank: None
  summary: A live hard-gate trial on a bounded troubleshooting prompt candidate showed strong target-slice gains but mixed control tradeoffs, so the decision is manual_review and the candidate was rolled back from live runtime.
  body: Trial hardgate_20260415_routing001_traceback_guard ran target/control/holdout stages against live /api/chat. Target reward delta was +0.577 with fail/borderline reductions, but control reward delta was -0.0083 with increases in grounding (+1) and tool-selection (+1) counts (within thresholds but directionally negative). Holdout reward delta was +0.0785. Final decision recorded as manual_review, with full artifacts under evals/optimizer/trials/hardgate_20260415_routing001_traceback_guard/. Candidate prompt mutation was reverted in prompts/system/layers/task_operations_troubleshooting_v1.md a...
  evidence: /mnt/data/friday/evals/optimizer/trials/hardgate_20260415_routing001_traceback_guard/stage_results.json; /mnt/data/friday/evals/optimizer/trials/hardgate_20260415_routing001_traceback_guard/trial_result.json; /mnt/data/friday/prompts/system/layers/task_operations_troubleshooting_v1.md; /mnt/data/friday/evals/optimizer/trials/hardgate_20260415_routing001_traceback_guard/trial_report.md
  explanation: path=recent_in_scope_shadow_supplement sources=['scope_key', 'status', 'updated_at'] tokens=[]
- [6c7f8245-1952-4464-8998-79725736746e] Althing memory audit identifies bridge/direct split and missing private whiteboard
  ...
  explanation: path=recent_in_scope_shadow_supplement sources=['scope_key', 'status', 'updated_at'] tokens=[]
- [c9da15a8-7aa4-4471-a717-d7379249fa7f] Run Friday optimizer v1 with persisted splits and staged candidate trials
  kind: runbook status: active stage: recent_in_scope_supplement
  score: None rank: None
  summary: Use splits.py to generate deterministic tuning/control/holdout sets, propose candidates, run run_trial or optimize entrypoint, then inspect trial bundles and ledger for gate decisions.
  body: Core flow: (1) build data_splits_v1 from analysis_results; (2) generate candidates via propose_candidates (human_seeded or model_assisted); (3) run staged trials with run_trial/optimize using baseline and candidate analysis sources or live mode; (4) read promotion recommendations and ledger rows; (5) stage promotion/rollback records with apply_promotion and rollback scripts.
  evidence: /mnt/data/friday/evals/optimizer/README.md; /mnt/data/friday/evals/optimizer/runs/optimizer_harness_v1_batch/trial_summary.json; /mnt/data/friday/evals/optimizer/splits.py; /mnt/data/friday/evals/optimizer/propose_candidates.py
  explanation: path=recent_in_scope_shadow_supplement sources=['scope_key', 'status', 'updated_at'] tokens=[]
- [d5f1c931-3233-46df-96f3-5c5645bfc86c] Friday now has a bounded synthetic optimizer harness v1 over safe policy surfaces
  kind: decision status: active stage: recent_in_scope_supplement
  score: None rank: None
  summary: Added evals/optimizer modules implementing explicit reward scoring, deterministic split discipline, bounded candidate schema, staged trial execution, explicit promotion gate, and durable trial ledger without model-weight updates.
  body: The harness now supports human-seeded and model-assisted candidate proposals, tuning/control/holdout staged evaluation, promote/reject/manual_review decisions, and promotion/rollback metadata artifacts. It reuses existing eval/analysis outputs and adds machine-usable objective/gate contracts for replayable optimization.
  evidence: /mnt/data/friday/evals/remediation/remediation_pass_v4_optimizer_harness_report.md; /mnt/data/friday/evals/optimizer/optimize.py; /mnt/data/friday/evals/optimizer/run_trial.py; /mnt/data/friday/evals/optimizer/promotion.py
  explanation: path=recent_in_scope_shadow_supplement sources=['scope_key', 'status', 'updated_at'] tokens=[]
- [ecc7842e-8058-4603-b3a0-633970ad4db5] V3 routing+prompt pass completed with targeted and full reruns
  ...
  explanation: path=recent_in_scope_shadow_supplement sources=['scope_key', 'status', 'updated_at'] tokens=[]
- [7c366fc3-ec1f-455f-8c7a-3d2ea90ff178] Friday remediation v2 rerun and delta artifacts for failed/borderline and full corpus
  kind: runbook status: active stage: recent_in_scope_supplement
  score: None rank: None
  summary: Completed full failed/borderline replay from combined_full_v1 plus full combined rerun, then generated analysis runs and machine-readable baseline deltas.
  body: Rerun IDs: combined_failed_rerun_v2 and combined_full_v2. Analysis IDs: combined_failed_rerun_v2_analysis_v1 and combined_full_v2_analysis_v1. Delta artifacts: evals/remediation/failed_rerun_delta.json + .md and evals/remediation/combined_v1_to_v2_delta.json + .md. Full combined runner summary reached 350/350 successful transport responses.
  evidence: /mnt/data/friday/evals/runs/combined_failed_rerun_v2/run_summary.json:1; /mnt/data/friday/evals/remediation/combined_v1_to_v2_delta.json:1; /mnt/data/friday/evals/runs/combined_full_v2/run_summary.json:1
  explanation: path=recent_in_scope_shadow_supplement sources=['scope_key', 'status', 'updated_at'] tokens=[]
...
- [12b5855a-7314-47e4-9829-991a0a9cc74b] card=7c366fc3-ec1f-455f-8c7a-3d2ea90ff178 type=file ref=/mnt/data/friday/evals/runs/combined_failed_rerun_v2/run_summary.json:1
- [3971142e-3da1-4e2e-a788-cffb16db7649] card=7c366fc3-ec1f-455f-8c7a-3d2ea90ff178 type=file ref=/mnt/data/friday/evals/remediation/combined_v1_to_v2_delta.json:1
- [e3c6c4a6-c6a9-448a-b1b5-5af87187d1d7] card=7c366fc3-ec1f-455f-8c7a-3d2ea90ff178 type=file ref=/mnt/data/friday/evals/runs/combined_full_v2/run_summary.json:1
...
- [37ee3335-92d1-454c-9740-d8d6995d7b76] card=c9da15a8-7aa4-4471-a717-d7379249fa7f type=file ref=/mnt/data/friday/evals/optimizer/README.md
- [3d5d8d0d-740e-4e97-9983-c6033730ad33] card=c9da15a8-7aa4-4471-a717-d7379249fa7f type=file ref=/mnt/data/friday/evals/optimizer/runs/optimizer_harness_v1_batch/trial_summary.json
- [5b08f000-07d1-46d9-a90a-2343426839be] card=c9da15a8-7aa4-4471-a717-d7379249fa7f type=file ref=/mnt/data/friday/evals/optimizer/splits.py
- [ef972b9d-c5a3-4314-ac14-6751feeea621] card=c9da15a8-7aa4-4471-a717-d7379249fa7f type=file ref=/mnt/data/friday/evals/optimizer/propose_candidates.py
...
- [25696251-fea3-4707-b793-3881ffc6a45d] card=d5f1c931-3233-46df-96f3-5c5645bfc86c type=file ref=/mnt/data/friday/evals/remediation/remediation_pass_v4_optimizer_harness_report.md
- [5351fde3-7bc4-4b88-971f-b227361db799] card=d5f1c931-3233-46df-96f3-5c5645bfc86c type=file ref=/mnt/data/friday/evals/optimizer/optimize.py
- [d42df64f-036a-4e49-a43a-629908875093] card=d5f1c931-3233-46df-96f3-5c5645bfc86c type=file ref=/mnt/data/friday/evals/optimizer/run_trial.py
- [fbf56dc8-55c6-4297-ba2d-593d48d7e8cf] card=d5f1c931-3233-46df-96f3-5c5645bfc86c type=file ref=/mnt/data/friday/evals/optimizer/promotion.py
- [38f32c23-b9a6-4f8d-aaae-86a461b602ee] card=da270af3-a737-4ad5-a652-92751cb57de2 type=file ref=/mnt/data/friday/evals/optimizer/trials/hardgate_20260415_routing001_traceback_guard/stage_results.json
- [60980baa-ffef-4bcc-b44e-99937e611de8] card=da270af3-a737-4ad5-a652-92751cb57de2 type=file ref=/mnt/data/friday/evals/optimizer/trials/hardgate_20260415_routing001_traceback_guard/trial_result.json
- [da3a44d4-f17a-4f32-92cf-c0bfe275547b] card=da270af3-a737-4ad5-a652-92751cb57de2 type=file ref=/mnt/data/friday/prompts/system/layers/task_operations_troubleshooting_v1.md
- [f6b54a4b-a96d-4cf0-a273-166edfb1cfe2] card=da270af3-a737-4ad5-a652-92751cb57de2 type=file ref=/mnt/data/friday/evals/optimizer/trials/hardgate_20260415_routing001_traceback_guard/trial_report.md
...
- Continuity: Hard-gate trial for routing_001 traceback guard set to manual_review - A live hard-gate trial on a bounded troubleshooting prompt candidate showed strong target-slice gains but mixed control tradeoffs, so the decision is manual_review and the candidate was rolled back from live runtime.
