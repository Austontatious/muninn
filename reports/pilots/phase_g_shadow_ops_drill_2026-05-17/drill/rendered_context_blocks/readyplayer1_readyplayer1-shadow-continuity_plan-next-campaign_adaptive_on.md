...
task: plan ReadyPlayer1 next campaign preserving 007A 006A 005A 004A lessons and SubSim evaluation contract
...
- [1eb0763c-9d10-446c-9ca0-e4ef2ac02cb0] Campaign 004A promoted with ReadyPlayer1 fire-control loop patch
  ...
  explanation: path=v2_hybrid_recall sources=['body', 'evidence', 'reinforcement_state', 'summary', 'title', 'vector'] tokens=['004a', '005a', 'campaign', 'next', 'preserving', 'readyplayer1', 'subsim']
- [fbcac688-f952-477f-87ca-ea7860c4f396] Campaign 006A promoted post-loss recovery probe
  kind: decision status: active stage: primary_retrieval reason: query_match
  score: 162.943709 rank: 2
  ...
  explanation: path=v2_hybrid_recall sources=['body', 'evidence', 'reinforcement_state', 'summary', 'title', 'vector'] tokens=['005a', '006a', 'campaign', 'preserving', 'readyplayer1', 'subsim']
- [bef388b3-b3d2-4d14-ae7c-bda5b0fb4d44] Campaign 005A promoted fire-control state normalization
  kind: decision status: active stage: primary_retrieval reason: query_match
  score: 150.215314 rank: 3
  ...
  explanation: path=v2_hybrid_recall sources=['body', 'evidence', 'reinforcement_state', 'summary', 'title', 'vector'] tokens=['004a', '005a', 'campaign', 'readyplayer1', 'subsim']
...
- [0afb7524-b5b6-4e78-9a56-a08915eb895e] Campaign 007A promoted post-reacquisition stabilization
  ...
  explanation: path=recent_in_scope_shadow_supplement sources=['query_tokens', 'title_summary_tokens', 'primary_result_domain_tokens', 'numeric_tokens'] tokens=['007a', 'acoustic', 'after', 'baseline', 'belief', 'binding', 'bounded', 'campaign', 'change', 'changes', 'clutter', 'compatible', 'contact', 'count', 'decision', 'drift', 'duplicate', 'emits', 'evidence', 'fail', 'gates', 'golden', 'high', 'made', 'metrics', 'moved', 'pass', 'passed', 'physics', 'policy', 'post', 'preserved', 'preserving', 'primary', 'probe', 'promoted', 'rate', 'reacquisition', 'readyplayer1', 'rebind', 'recovery', 'regression', 'replay', 'same', 'scenario', 'shot', 'sonar', 'stayed', 'subsim', 'suite', 'torpedo', 'track', 'tracks', 'wasted', 'while', 'wrong']
- [719fafb5-b25b-4460-a549-987799432a6c] Campaign 004A fire-control loop promoted
  ...
  explanation: path=recent_in_scope_shadow_supplement sources=['query_tokens', 'title_summary_tokens', 'primary_result_domain_tokens', 'numeric_tokens'] tokens=['004a', 'acoustic', 'after', 'baseline', 'belief', 'binding', 'campaign', 'clean', 'clutter', 'commits', 'contact', 'control', 'count', 'decision', 'drift', 'duplicate', 'evidence', 'fail', 'fire', 'full', 'gates', 'heldout', 'loop', 'metrics', 'normalized', 'observations', 'pass', 'passed', 'preserving', 'primary', 'promoted', 'rate', 'rationale', 'reacquisition', 'readyplayer1', 'regression', 'replay', 'same', 'scenario', 'shot', 'single', 'sonar', 'subsim', 'suite', 'suppresses', 'tests', 'torpedo', 'tracking', 'uses', 'wasted', 'while', 'wrong']
- [8db59c21-0224-4ef0-b628-f336867bf591] Campaign 003 acoustic clutter binding integrated
  ...
  explanation: path=recent_in_scope_shadow_supplement sources=['query_tokens', 'title_summary_tokens', 'primary_result_domain_tokens'] tokens=['acoustic', 'adds', 'baseline', 'belief', 'binding', 'bounded', 'campaign', 'clutter', 'contact', 'decision', 'evidence', 'focused', 'heldout', 'high', 'metrics', 'moved', 'primary', 'reacquire', 'readyplayer1', 'risk', 'stayed', 'subsim', 'suite', 'tests', 'track', 'tracks', 'under', 'while', 'wrong']
- [2656c35f-79af-403d-9128-e98fc72663d6] Campaign 003 promoted for SubSim clutter binding
  ...
  explanation: path=recent_in_scope_shadow_supplement sources=['query_tokens', 'title_summary_tokens', 'primary_result_domain_tokens'] tokens=['after', 'baseline', 'belief', 'binding', 'campaign', 'clutter', 'contacts', 'decision', 'emits', 'fail', 'false', 'golden', 'metrics', 'moved', 'pass', 'positive', 'primary', 'promoted', 'rate', 'readyplayer1', 'regression', 'scenario', 'sonar', 'subsim', 'suite', 'track', 'tracks', 'uses', 'while', 'wrong']
- [4be809aa-731f-420c-8dc1-99cb5813c0ea] Campaign 002A promoted for SubSim sonar lifecycle diagnostics
  ...
  explanation: path=recent_in_scope_shadow_supplement sources=['query_tokens', 'title_summary_tokens', 'primary_result_domain_tokens'] tokens=['active', 'after', 'baseline', 'belief', 'binding', 'campaign', 'clutter', 'contact', 'contacts', 'decision', 'explicit', 'fail', 'false', 'golden', 'lost', 'metrics', 'normalizes', 'pass', 'positive', 'preserved', 'promoted', 'rate', 'readyplayer1', 'regression', 'sonar', 'stayed', 'subsim', 'suite', 'them', 'tracks', 'while']
- [fb80c2a4-3025-4a64-bd60-3cbf7484b2d2] SubSim ReadyPlayer1 evaluation contract v1 documented
  ...
  explanation: path=recent_in_scope_shadow_supplement sources=['query_tokens', 'title_summary_tokens', 'primary_result_domain_tokens'] tokens=['baseline', 'belief', 'campaign', 'clutter', 'commits', 'contract', 'decision', 'evaluation', 'false', 'full', 'golden', 'loop', 'metrics', 'only', 'passed', 'positive', 'readyplayer1', 'regression', 'replay', 'scenario', 'seed', 'status', 'subsim', 'suite']
...
- Continuity: Campaign 002A promoted for SubSim sonar lifecycle diagnostics - Campaign 002A added explicit sonar contact lifecycle states and lifecycle-aware ReadyPlayer1 diagnostics. The belief_baseline suite stayed at 7 pass / 0 fail with golden regression pass, while clutter_false_positive removed binding_ambiguity_abandonment and preserved clutter_binding_error.
