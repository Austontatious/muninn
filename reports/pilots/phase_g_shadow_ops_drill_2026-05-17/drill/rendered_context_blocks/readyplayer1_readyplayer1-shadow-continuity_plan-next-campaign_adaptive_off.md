...
- [1eb0763c-9d10-446c-9ca0-e4ef2ac02cb0] Campaign 004A promoted with ReadyPlayer1 fire-control loop patch
  ...
  explanation: path=v2_hybrid_recall sources=['body', 'evidence', 'summary', 'title', 'vector'] tokens=['004a', '005a', 'campaign', 'next', 'preserving', 'readyplayer1', 'subsim']
- [fbcac688-f952-477f-87ca-ea7860c4f396] Campaign 006A promoted post-loss recovery probe
  kind: decision status: active stage: primary_retrieval reason: query_match
  score: 147.754501 rank: 2
  ...
  explanation: path=v2_hybrid_recall sources=['body', 'evidence', 'summary', 'title', 'vector'] tokens=['005a', '006a', 'campaign', 'preserving', 'readyplayer1', 'subsim']
- [bef388b3-b3d2-4d14-ae7c-bda5b0fb4d44] Campaign 005A promoted fire-control state normalization
  kind: decision status: active stage: primary_retrieval reason: query_match
  score: 135.026106 rank: 3
  ...
  explanation: path=v2_hybrid_recall sources=['body', 'evidence', 'summary', 'title', 'vector'] tokens=['004a', '005a', 'campaign', 'readyplayer1', 'subsim']
